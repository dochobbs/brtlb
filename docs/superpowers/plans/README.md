...
| Phase | Plan                                                      | Status   |
| ----- | --------------------------------------------------------- | -------- |
| 1     | [Foundation](2026-04-26-phase-1-foundation.md)            | Complete |
| 2     | [Pipeline core](2026-04-26-phase-2-pipeline.md)           | Complete |
| 3     | [Data layer](2026-04-26-phase-3-data-layer.md)            | Complete |
| 3.5   | Encrypted storage (SQLCipher + key derivation + keychain) | Pending  |
